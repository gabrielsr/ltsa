...
/** The tokens used to compile FSP syntax */
public class Symbol implements ISymbol {
    ...
    /** Used for the value of double precision numbers */
    ...
    public Color getColor() {
        ...
        if (kind > 0 && kind <= INIT || kind == FLOAT || kind == COUNTER || kind == TIMER || kind == MEASURE)
            return Color.blue;
    ...
    public String toString() {
        ...
        case ALLOR:           	 return "allOr";
        case ALLAND:             return "allAnd";
        ...
        case DOUBLE_VALUE:           return doubleValue + "";
    ...
    public static final int ALLOR = 24;
    public static final int ALLAND = 25;
    public static final int RIGID = 26;
    ...
    public static final int TIMER = 129;
    public static final int COUNTER = 130;
    public static final int MEASURE = 131;
