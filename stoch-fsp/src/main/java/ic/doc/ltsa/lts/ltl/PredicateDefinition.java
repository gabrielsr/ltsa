...
public class PredicateDefinition implements IPredicateDefinition {
    ...
    ISymbol name;
    IActionLabels trueSet, falseSet;
    Vector trueActions, falseActions;
    Stack expr;
    boolean initial;
    IActionLabels range;    //range of fluents

    static Hashtable definitions;
    
    public PredicateDefinition() {}
    
    private PredicateDefinition(ISymbol n, IActionLabels rng, IActionLabels ts, IActionLabels fs, Stack es){
	name = n;
	range = rng;
	trueSet = ts;
	falseSet = fs;
    ...
    public static void put(ISymbol n, IActionLabels rng, IActionLabels ts, IActionLabels fs, Stack es) {
    ...
    public static boolean contains(ISymbol n)  {
