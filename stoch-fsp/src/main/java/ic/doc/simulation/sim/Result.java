...
/** Represents a result for a performance measure, obtained via
 * simulation.
 *
 * @author Thomas Ayles
...
public abstract class Result {
    ...
    /** Creates a new result for the given source.
     * @param source The source of the result.
     */
    public Result( PerformanceMeasure source ) {
	this.source = source;
    }
     ...
     */
    public PerformanceMeasure getSource() { return source; }
}
